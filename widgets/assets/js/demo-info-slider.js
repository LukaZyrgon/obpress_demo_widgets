jQuery( window ).on( 'elementor/frontend/init', function() {
  ...
  elementorFrontend.hooks.addAction( 'frontend/element_ready/SpaBot.default', function($scope, $){
      var swiperSettings = {};
      var swiperSelector = jQuery(".obpress-spa-top-holder");
      swiperSettings.slidesPerView = Number(swiperSelector.data("slides-per-view"));
